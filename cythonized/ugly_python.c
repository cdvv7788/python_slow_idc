...
static PyObject *__pyx_kp_s_home_cristian_hobby_pythoncali;
 ...
 *         output = output + 'a'             # <<<<<<<<<<<<<<
 */
    __pyx_t_3 = PyNumber_Add(__pyx_v_output, __pyx_n_s_a); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 11, __pyx_L1_error)
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_home_cristian_hobby_pythoncali, __pyx_k_home_cristian_hobby_pythoncali, sizeof(__pyx_k_home_cristian_hobby_pythoncali), 0, 0, 1, 0},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initugly_python(void); /*proto*/
PyMODINIT_FUNC initugly_python(void)
#else
PyMODINIT_FUNC PyInit_ugly_python(void); /*proto*/
PyMODINIT_FUNC PyInit_ugly_python(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_ugly_python(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("ugly_python", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_default_timer, __pyx_t_1) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
